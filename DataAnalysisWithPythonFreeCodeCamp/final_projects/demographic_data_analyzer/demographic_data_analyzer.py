...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_countries = pd.Series(dtype='float64')
    for i in df['native-country'].unique():
        amount_earning_50K = df.loc[(df['salary'] == ">50K") & (df['native-country'] == i)].shape[0]
        highest_earning_countries[i] = (amount_earning_50K / df.loc[df['native-country'] == i].shape[0]) * 100
